<template>
  <div class="app-container">
    ...
    <el-table style="width: 100%"
      ...
      <el-table-column prop="attrCode" label="属性代码"></el-table-column>
      <el-table-column prop="attrInputType" label="属性输入类型"></el-table-column>
      <el-table-column prop="attrType" label="属性类型"></el-table-column>
      <el-table-column prop="attrIndex" label="属性检索类型"></el-table-column>
      <el-table-column prop="sortOrder" label="显示属性"></el-table-column>
      <el-table-column prop="isLinked" label="推荐其他属性产品"></el-table-column>
      <el-table-column prop="attrValues" label="属性值"></el-table-column>
