  ...
  <div class="app-container">
    ...
    <el-row>
      ...
      <el-tooltip class="item" content="搜索" placement="top" >
        <el-button icon="el-icon-search" circle @click="fetchData(1)" v-perm="'b:sku:category'"></el-button>
      </el-tooltip>
    </el-row>
    <div style="margin-bottom: 30px;"></div>
    <el-button type="primary" icon="el-icon-plus"
               @click="handleCreate" v-perm="'b:sku:category'">{{textMap.create}}</el-button>
    <div style="margin-bottom: 30px;"></div>
    <!--列表-->
    <el-table style="width: 100%"
      ...
      <el-table-column prop="parentId" label="品牌图片"></el-table-column>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" width="20%">
      <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="120px">
        ...
        <el-form-item label="分类名称" prop="categoryName" v-if="dialogStatus=='create'">
          <el-input v-model="temp.categoryName"></el-input>
        </el-form-item>

        <el-form-item label="分类代码" prop="categoryCode">
          <el-input v-model="temp.categoryCode"></el-input>
        </el-form-item>

        <el-form-item label="分类父ID" prop="parentId">
  ...
  export default {
    ...
    methods: {
      ...
      fetchData(current) {
        ...
        skuApi.queryCategory(this.tableQuery, this.tablePage).then(res => {
      ...
      createData() {
        this.$refs['dataForm'].validate((valid) => {
          if (!valid) return;
        skuApi.addCategory(this.temp).then((res) => {
