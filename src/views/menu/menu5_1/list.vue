<template>
  <div class="app-container">
    ...
    <el-table style="width: 100%"
      ...
      <el-table-column prop="parentId" label="品牌父类"></el-table-column>
      <el-table-column prop="brandName" label="品牌名称"></el-table-column>
      <el-table-column prop="brandEnName" label="品牌英文名称"></el-table-column>
      <el-table-column prop="brandCode" label="品牌代码"></el-table-column>
      <el-table-column prop="brandLogo" label="品牌图片">
        <template slot-scope="scope">
          <img :src="scope.row.brandLogo" style="width: 100px;height: 100px;display: block;" />
        </template>
      </el-table-column>
      <el-table-column prop="brandDesc" label="品牌描述"></el-table-column>
      <el-table-column prop="brandEnDesc" label="品牌英文描述"></el-table-column>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      handleCreate() {
        this.$router.push({
          path: '/menu5/menu5_1/addBrand'
        })
      },
      handleUpdate(idx, row) {
        this.$router.push({
          path: '/menu5/menu5_1/editBrand/' + row.id
        })
      },
